...
def login():
    if request.method == "POST":
        ...
        if usuario_logeado != None:
            ...
            return render_template("auth/login.html", tipo= "danger")
    else:
...
def comprar_libro():
    ...
    try:
        ...
        #confirmacion_compra(mail, current_user, libro) #envio Syn
        confirmacion_compra(app, mail, current_user, libro) #envio Asyn
    except Exception as ex:
